      ...
      {loadState === 'success' && request && (
        <article className="panel detail-card">
          ...
          <div className="action-buttons">
            <button
              className={`button status-btn ${request.status === 'pending' ? 'active pending' : ''}`}
            ...
            <button
              className={`button status-btn ${request.status === 'in-progress' ? 'active in-progress' : ''}`}
            ...
            <button
              className={`button status-btn ${request.status === 'completed' ? 'active completed' : ''}`}
