...
export function createApp() {
  ...
  /**
   *  W06-A1 (CP03) · ติดตั้ง middleware — ต้องมาก่อน route เสมอ
  ...
  //W06-A2 (CP01) · route ทดสอบว่าเซิร์ฟเวอร์ทำงาน
  ...
  /*
   *  W06-A3 (CP02) · เชื่อม requestRoutes เข้ากับ path /api/requests
   *   app.use('/api/requests', requestRoutes)
   */

  // เชื่อม requestRoutes เข้ากับ path /api/requests
  app.use('/api/requests', requestRoutes);
