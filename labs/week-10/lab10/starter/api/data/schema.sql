...
--                email (TEXT, ห้ามว่าง, ห้ามซ้ำ)
            CREATE TABLE users (
                id INTEGER PRIMARY KEY AUTOINCREMENT , --AUTOINCREMENT ใช้กับเฉพาะ ที่เป็น INTEGER
                name TEXT NOT NULL ,
                department TEXT NOT NULL ,
                email TEXT NOT NULL UNIQUE ); --UNIQUE คือ ห้ามซ้ำ email ไม่สามารถซ้ำได้
...
--         users อย่างน้อย 4 คน · requests อย่างน้อย 5 รายการ
        INSERT INTO users (name, department, email) VALUES
            ('อังคาร สกุลบุญดี',      'วิศวกรรมซอฟต์แวร์', 'aungkanr@rmutl.ac.th'),
            ('กิตติทัต กันธรรม', 'วิศวกรรมซอฟต์แวร์', 'kit.k@rmutl.ac.th'),
            ('ปริวัตต์ เทพอินทร์',     'วิศวกรรมไฟฟ้า',     'pariwat@rmutl.ac.th'),
            ('ภานุภงศ์ ทองดี',   'สำนักวิทยบริการ',   'panupong@rmutl.ac.th');
        ...
        INSERT INTO requests (id, requester_id, request_type, location, details, priority, status) VALUES 
            ...
            ('REQ-005', 4, 'อื่นๆ', 'ห้องสมุด ชั้น 2', 'ขอเพิ่มปลั๊กไฟบริเวณโต๊ะอ่านหนังสือ', 'normal', 'pending'),
