...
code curl "http://localhost:3001/api/requests?status=x'%20OR%20'1'='1"
...
# ② พยายามลบตาราง
code curl "http://localhost:3001/api/requests?status='%3B%20DROP%20TABLE%20requests%3B%20--"

ผลที่ได้ [] 0 รายการ

เพราะ อักขระพิเศษและคำสั่งถูกมองเป็นสตริง ค้นหาไม่พบข้อมูล และไม่นำไปรันเป็นคำสั่งทำลายฐานข้อมูล



# ③ ต่อเงื่อนไขเพิ่ม
code curl "http://localhost:3001/api/requests?status=pending'%20OR%20status='completed"

ผลที่ได้ [] 0 รายการ

เพราะ ระบบนำข้อความทั้งหมดไปค้นหาตรงๆ เป็นก้อนเดียวกัน ไม่แตกเงื่อนไข OR ออกมาทำงาน
